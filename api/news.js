module.exports = async function handler(req, res) {
  ...
  // Map common index symbols to Yahoo Finance format
  if (sym === 'VIX') sym = '^VIX';
  if (sym === 'SPX' || sym === 'SPY') sym = '^GSPC';
  if (sym === 'DJI' || sym === 'DIA') sym = '^DJI';
  if (sym === 'NDX' || sym === 'QQQ') sym = '^IXIC';
  ...
  try {
    ...
    console.error('[news.js] Error fetching Yahoo RSS:', err);
